...
struct mm_type_to_sol {
    ...
    template std::vector<char> incremental_mm_agreement_rounding_cuda(typename bdd_solver::cuda_parallel_mma_double_type& , double , const double, const int, const bool, const int);
    template std::vector<char> incremental_mm_agreement_rounding_cuda(typename bdd_solver::cuda_parallel_mma_float_type& , double , const double, const int, const bool, const int);
    template std::vector<char> incremental_mm_agreement_rounding_cuda(typename bdd_solver::cuda_lbfgs_parallel_mma_float_type& , double , const double, const int, const bool, const int);
    template std::vector<char> incremental_mm_agreement_rounding_cuda(typename bdd_solver::cuda_lbfgs_parallel_mma_double_type& , double , const double, const int, const bool, const int);
    ...
    template std::vector<char> perturb_primal_costs(typename bdd_solver::cuda_parallel_mma_float_type& , const double, const int, const bool );
    template std::vector<char> perturb_primal_costs(typename bdd_solver::cuda_parallel_mma_double_type& , const double, const int, const bool );
    template std::vector<char> perturb_primal_costs(typename bdd_solver::cuda_lbfgs_parallel_mma_float_type& , const double, const int, const bool );
    template std::vector<char> perturb_primal_costs(typename bdd_solver::cuda_lbfgs_parallel_mma_double_type& , const double, const int, const bool );
