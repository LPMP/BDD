...
#pragma omp parallel for
    ...
    two_dim_variable_array<size_t> ILP_input::variable_adjacency_matrix() const
    {
    ...
    */
    ...
    two_dim_variable_array<size_t> ILP_input::bipartite_variable_bdd_adjacency_matrix() const
    {
        MEASURE_FUNCTION_EXECUTION_TIME
...
//#pragma omp parallel for schedule(guided)
    ...
    permutation ILP_input::reorder_bfs()
    {
    ...
    permutation ILP_input::reorder_Cuthill_McKee()
    {
        const auto adj = bipartite_variable_bdd_adjacency_matrix();
    ...
    permutation ILP_input::reorder_minimum_degree_ordering()
    {
        const auto adj = bipartite_variable_bdd_adjacency_matrix();
