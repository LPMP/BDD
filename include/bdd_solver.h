...
namespace LPMP {
    ...
    class bdd_solver {
        public:
            ...
            using lbfgs_parallel_mma_float_type = lbfgs<bdd_parallel_mma_base<bdd_branch_instruction<float, uint16_t>>, std::vector<float>, float, std::vector<char>>;
            using lbfgs_parallel_mma_double_type = lbfgs<bdd_parallel_mma_base<bdd_branch_instruction<double, uint16_t>>, std::vector<double>, double, std::vector<char>>;
            ...
            using cuda_lbfgs_parallel_mma_float_type = lbfgs<bdd_cuda_parallel_mma<float>, thrust::device_vector<float>, float, thrust::device_vector<char>>;
            using cuda_lbfgs_parallel_mma_double_type = lbfgs<bdd_cuda_parallel_mma<double>, thrust::device_vector<double>, double, thrust::device_vector<char>>;
#endif
